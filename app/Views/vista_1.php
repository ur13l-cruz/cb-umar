...
<div class="container-fluid " style="background-color: rgb(0 69 118); color:white;">
  <div class="container">
    <p class="">
      ...
      <a class="text-decoration-none link-light">&emsp;Vista 1&emsp;<?= $especie->dtaxonomicos_nombre_comun ?></a>
    </p>
  </div>
</div>
...
<div class="container mt-5 mb-5">
  ...
  <div class="row mt-5">
    <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
      ...
      <?php if ($especie->img_distribucion_v1) { ?>
    ...
    <div class="tab-content" id="myTabContent">
      ...
      <?php if ($especie->img_distribucion_v1) { ?>
        <div class="tab-pane fade text-center" id="mapa-tab-pane" role="tabpanel" aria-labelledby="mapa-tab" tabindex="0">
          <figure class="figure mt-2">
            <img class="w-75" src="<?= base_url() ?>public/img/distribucion/vista1/<?= $especie->id ?>.png" alt="" srcset="">
            <figcaption class="figure-caption"><?= $especie->fuente_img_distribucion_v1 ?></figcaption>
          </figure>
        </div>
      <?php } ?>
      <div class="tab-pane fade " id="descripcion-tab-pane" role="tabpanel" aria-labelledby="descripcion-tab" tabindex="0">
        <div class="accordion mt-2" id="accordionExample">
          ...
          <?php } ?>
          <?php if ($especie->img_coloracion_v1) { ?>
            <div class="accordion-item">
              <h2 class="accordion-header">
          ...
          <?php } ?>
          <?php if ($especie->img_historia_natural_v1) { ?>
            <div class="accordion-item">
              <h2 class="accordion-header">
          ...
          <?php } ?>
          <?php if ($especie->carrusel_tipo_vegetacion_v1) { ?>
            <div class="accordion-item">
              <h2 class="accordion-header">
          ...
          <?php } ?>
          <?php if ($especie->carrusel_alimentacion_v1) { ?>
            <div class="accordion-item">
              <h2 class="accordion-header">
