...
<div class="container-fluid " style="background-color: rgb(0 69 118); color:white;">
  <div class="container">
    <p class="">
      ...
      <a class="text-decoration-none link-light">&emsp;Vista 1</a>&emsp;>
      <a class="text-decoration-none link-light">&emsp;<?php echo $especie->id ?></a>&emsp;
    </p>
  </div>
</div>
...
<div class="container mt-5 mb-5">
  <div class="row mb-3">
    <div class="col-12 col-sm-6 text-center">
      <h5><?php echo $especie->dtaxonomicos_nombre_comun ?></h5>
    </div>
    <div class="col-12 col-sm-6 text-center">
  ...
  <div class="row">
    <div class="col-12 col-sm-6 order-2 order-sm-1">
      <div class="row">
        ...
        <?php
        if ($existeRuta) {
          echo '<figcaption class="figure-caption text-center">Fuente: ' . $especie->fuentes_carrusel_especie_viva . '</figcaption>';
        }
        ?>
      </div>
      <div class="row mt-3">
        ...
        <figcaption class="figure-caption text-center">Fuente: <?php echo $especie->fuentes_carrusel_especie_coleccion ?></figcaption>
      </div>
    </div>
    ...
    <div class="tab-content" id="myTabContent">
          ...
          <div class="accordion-item">
            ...
            <div id="collapseEstoyEnPeligro" class="accordion-collapse collapse show" data-bs-parent="#accordionExample1">
              <div class="accordion-body text-center">
                <figure class="figure">
                  <img class="w-75" src="<?php echo base_url() ?>public/img/IMG_20230412_164226.jpg" alt="" srcset="">
      ...
      <div class="tab-pane fade text-center" id="mapa-tab-pane" role="tabpanel" aria-labelledby="mapa-tab" tabindex="0">
        <figure class="figure mt-2">
          <img class="w-75" src="<?php echo base_url() ?>public/img/distribucion/vista1/<?php echo $especie->id ?>.png" alt="" srcset="">
          <figcaption class="figure-caption"><?php echo $especie->fuente_img_distribucion_v1 ?></figcaption>
        </figure>
      </div>
          ...
          <div class="accordion-item">
            ...
            <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              ...
              <div class="text-center">
                <figcaption class="figure-caption">Fuente imagenes.</figcaption>
              </div>
            </div>
          </div>
          <div class="accordion-item">
